...
export const Dropdown = ({selectPlaceholder, options, label}: IDropdown) =>{
    ...
    return(
        <label className="block">
            ...
            <select className="w-full text-base md:text-lg text-system px-2 py-1 transition-all cursor-pointer duration-150 hover:bg-secondary-light  bg-secondary outline-none rounded"  name="" id="">
